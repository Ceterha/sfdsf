(() => {
    ...
    const menu = document.querySelector(".menu-body__list");
    if (iconMenu) {
    ...
    let app_text = "Общение с клиентами станет простым  и удобным, а подключение займет 5 минут. Первый месяц — бесплатним ";
    let delay = 34;
    let elem = document.querySelector(".promo__titles-desrc");
    ...
    print_text(app_text, elem, delay);
})();